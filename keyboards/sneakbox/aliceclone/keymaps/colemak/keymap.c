...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_alice_split_bs(
        KC_ESC,    KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,                 KC_7,    KC_8,    KC_9,    KC_0,       KC_MINS,   KC_EQL,     KC_LEFT,    KC_RGHT,
        KC_VOLU,   KC_TAB,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,                          KC_J,    KC_L,    KC_U,    KC_Y,       KC_SCLN,   KC_LBRC,    KC_RBRC,    KC_BSPC,
        KC_VOLD,   MO(2),   LT(1,KC_A),KC_R,    KC_S,    KC_T,    KC_D,                          KC_H,    KC_N,    KC_E,    KC_I,     LT(1,KC_O),  KC_QUOT,    KC_ENT,
                   KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                          KC_BSLS, KC_K,    KC_M,    KC_COMM,    KC_DOT,    KC_SLSH,    KC_RSFT,    KC_LGUI,
                   KC_LCTL,                     KC_LALT, MT(MOD_LCTL,KC_SPC),  KC_F12,           KC_ENT,  KC_CAPS,                                             KC_MPLY),
